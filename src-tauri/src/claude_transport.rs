...
mod tests {
    ...
    // Supuesto compartido con el resto de este archivo (ver ejecutable_presente_arranca_sin_producir_el_error_de_ausencia): la maquina de pruebas tiene claude.exe real instalado y en PATH -- CI lo instala via @anthropic-ai/claude-code antes de este job (ver .github/workflows/quality-gate.yml).
    #[test]

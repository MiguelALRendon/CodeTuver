...
$features = Get-ChildItem -Path $ProjectDir -Recurse -Filter *.feature -File -ErrorAction SilentlyContinue | Where-Object { $_.FullName -notmatch '_TEMPLATE' -and $_.FullName -notmatch '[\\/]node_modules[\\/]' }
